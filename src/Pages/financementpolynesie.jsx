          ...
          <div className="w-full">
            <article className="max-w-4xl mx-auto">
              ...
              <div className="">
                ...
                <p>
                  Le <a href="/" className="text-gray-900 hover:underline">financement non remboursable</a> en Polynésie 
                ...
                <p>
                  ...
                  Ensuite, vous allez vous rendre sur notre <a href="Demandefinance" className="text-gray-900 hover:underline">plateforme de demande de financement pour remplir notre formulaire de demande de financement</a>.
                </p>
